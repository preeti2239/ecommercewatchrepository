...
<title>Timex Analog Bule Dail</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Timex Analog Bule Dail </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/17.timex-original.jpg" style="height :400px;width: 200px"/>
            </div>
