...
<title>Street Line Fastrack</title>
</head>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Street Line Fastrack</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/2.STREET LINE ANA DIGI WATCH.jpg" style="height :400px;width: 400px"/>
            </div>
<center>
