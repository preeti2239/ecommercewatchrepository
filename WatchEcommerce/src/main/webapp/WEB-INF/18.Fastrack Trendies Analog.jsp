...
<title> Fastrack Trendies Analog</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Fastrack Trendies Analog </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/18.Fastrack Trendies Analog.jpg" style="height :400px;width: 200px"/>
            </div>
