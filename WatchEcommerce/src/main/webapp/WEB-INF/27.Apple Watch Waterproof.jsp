...
<title>Apple Watch IPX7 waterproof</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Apple Watch IPX7 waterproof </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/27.apple-watch1.jpg" style="height :400px;width: 400px"/>
            </div>
