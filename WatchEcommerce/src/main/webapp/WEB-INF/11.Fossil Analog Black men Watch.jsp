...
<title>Fossil Analog Black Men Watch</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Fossil Analog Black Men Watch </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/11.Fossil Analog Black men Watch.jpg" style="height :400px;width: 400px"/>
            </div>
