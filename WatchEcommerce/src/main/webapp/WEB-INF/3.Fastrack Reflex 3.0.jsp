...
<title>Fastrack Reflex 3.0</title>
</head>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Fastrack Reflex 3.0 </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/3.Fastrack Reflex 3.0 Unisex.jpg" style="height :400px;width: 400px">
            </div>
