...
<title>White Dial Ceramic</title>
</head>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> White Dial Ceramic </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/43.Titan White.jpg" style="height :400px;width: 400px"/>
            </div>
