...
<title>Wirst Watch Waterproof</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Wirst Watch Waterproof </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/30WristWorthy.jpg" style="height :400px;width: 400px"/>
            </div>
