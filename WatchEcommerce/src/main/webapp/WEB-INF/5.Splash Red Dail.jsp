...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Splash Red Dail</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/5Splash red dail Sonata.jpg" style="height :400px;width: 400px">
            </div>
