...
<title>Helix Smartwatch Timex</title>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Helix Smartwatch Timex </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/8.Helix Smart watch timex.jpg" style="height :400px;width: 400px"/>
            </div>
