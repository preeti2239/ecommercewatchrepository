...
<title> Samsung Galaxy Watch5</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Samsung Galaxy Watch5</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/20.Samsung Galaxy Watch5.jpg" style="height :400px;width: 400px"/>
            </div>
