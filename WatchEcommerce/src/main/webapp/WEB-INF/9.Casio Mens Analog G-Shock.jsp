...
<title>Casio Mens Analog G-Shock</title>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Casio Mens Analog G-Shock </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/9.Casio Mens analog G-shock.jpg" style="height :400px;width: 300px"/>
            </div>
