...
<head>
<meta charset="UTF-8">
<title>Fossil Women's Modern Watch</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Fossil Women's Modern Watch</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/13.Fossil.jpg" style="height :400px;width: 250px"/>
            </div>
