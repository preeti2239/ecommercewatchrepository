...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <a href="add">
            <button style=" float:right">🛒</button></a>
            <h2 style="text-align: center;color:red"> <u>Fossil Men Decker </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/12.Fossil men Decker.jpg" style="height :400px;width: 400px"/>
            </div>
