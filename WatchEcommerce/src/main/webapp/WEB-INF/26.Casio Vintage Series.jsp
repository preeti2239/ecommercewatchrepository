...
<title>Casio Vintage Series</title>
</head>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Casio Vintage Series</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/26.Casia_Vintage Series.jpg" style="height :400px;width: 200px"/>
            </div>
