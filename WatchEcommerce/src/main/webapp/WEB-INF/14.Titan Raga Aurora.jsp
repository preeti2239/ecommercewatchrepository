...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Titan Raga Aurora </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/14.Titan Raga Aurora - Copy.jpg" style="height :400px;width: 200px"/>
            </div>
        <br/><br/><br/>
