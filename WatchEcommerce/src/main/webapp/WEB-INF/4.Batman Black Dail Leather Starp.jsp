...
<title>Batman Black Dail Leather Starp</title>
</head>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Batman Black Dail Leather Starp </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/4.batman black dail leather starp.jpg" style="height :400px;width: 300px">
            </div>
