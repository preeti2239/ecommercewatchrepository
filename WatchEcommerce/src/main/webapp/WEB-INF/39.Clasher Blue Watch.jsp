...
<title>Clasher Blue Watch</title>
</head>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Clasher Blue Watch </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/39.Clasher Blue.jpg" style="height :400px;width: 300px"/>
            </div>
