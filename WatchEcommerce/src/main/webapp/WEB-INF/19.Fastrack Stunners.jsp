...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Fastrack Stunners</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/19.fasttrack Bule dail.jpg" style="height :400px;width: 400px"/>
            </div>
