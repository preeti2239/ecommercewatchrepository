...
<title>Gshock Waterproof 200m</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Gshock Waterproof 200m</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/28.G-shockWaterproof.jpg" style="height :400px;width: 400px"/>
            </div>
