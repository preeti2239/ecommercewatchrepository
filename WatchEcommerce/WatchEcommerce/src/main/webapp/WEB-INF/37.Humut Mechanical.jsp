...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Humut-Mechanical</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/37.HumutMechanical.jpg" style="height :400px;width: 300px"/>
            </div>
