...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> G-Shock Red Dail </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/10.Casio G-Shock Carbon Core Gaurd Analog-Digital Red Dial Men's Watch.jpg" style="height :400px;width: 400px"/>
            </div>
