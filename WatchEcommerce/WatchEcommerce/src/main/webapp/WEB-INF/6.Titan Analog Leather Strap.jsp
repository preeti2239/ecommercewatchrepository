...
<title>Titan Analog Leather Strap</title>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Titan Analog Leather Strap</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/6.Uptown Retreat Grey Dial Analog Purple Leather Strap Watch.jpg" style="height :400px;width: 400px"/>
            </div>
        ...
        <td><b>&#128666 Shipping days:<b>${product.delivery_days}</td>
         ...
         <div class="rightpane" style="text-align: center;">
            <br/><br/>
             ...
             <br/><br/>
            <a href="productlist">
            <button>&#128722 Add to cart</button>
        </a>
        </div>
</div>
