...
<title> Rolex Yatch master</title>
</head>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Rolex Yatch Master </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/41.Rolex.jpg" style="height :400px;width: 400px"/>
            </div>
