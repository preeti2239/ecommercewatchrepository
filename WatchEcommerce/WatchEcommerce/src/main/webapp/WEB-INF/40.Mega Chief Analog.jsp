...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Mega Cheif Analog </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/40.Mega cheif Analog.jpg" style="height :400px;width: 300px"/>
            </div>
