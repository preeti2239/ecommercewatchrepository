...
<title> Arcade-Grey Dail Silicon Strap FasTrack</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
         ...
         <h2 style="text-align: center;color:red"> <u> ${product.product_name}</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/${product.image}" style="height :400px;width:300px"/>
            </div>
<center>
