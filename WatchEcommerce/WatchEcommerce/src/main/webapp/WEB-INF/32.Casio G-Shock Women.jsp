...
<title> Casio G-Shock Women Rose Gold</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Casio G-Shock Women Rose Gold </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/32.G-shock sports.jpg" style="height :400px;width: 300px"/>
            </div>
