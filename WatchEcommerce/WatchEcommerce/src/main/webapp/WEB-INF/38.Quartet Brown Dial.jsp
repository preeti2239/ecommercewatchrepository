...
<title> Quartet Brown Dial</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Quartet Brown Dial </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/38.Quartet Brown dail.jpg" style="height :400px;width: 400px"/>
            </div>
