...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Sky-Dweller Rolex</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/29.Rolex_waterproof.jpg" style="height :400px;width: 400px"/>
            </div>
