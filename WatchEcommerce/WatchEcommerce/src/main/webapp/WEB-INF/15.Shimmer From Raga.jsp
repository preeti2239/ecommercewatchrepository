...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Shimmer From Raga </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/15.Raga-titan.jpg" style="height :400px;width: 400px"/>
            </div>
