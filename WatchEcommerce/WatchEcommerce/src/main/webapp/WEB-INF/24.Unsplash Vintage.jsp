...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Unsplash Vintage</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/24.Unspalsh vintage.jpg" style="height :400px;width: 400px"/>
            </div>
