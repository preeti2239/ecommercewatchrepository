...
<title> Casio Youth-Combination</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Casio Youth-Combination </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/33.Casio Sports.jpg" style="height :400px;width: 300px"/>
            </div>
