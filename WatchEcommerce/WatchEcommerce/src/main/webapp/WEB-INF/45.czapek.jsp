...
<title>Place Vendôme Titanium </title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Place Vendôme Titanium </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/45.czapek.jpg" style="height :400px;width: 200px"/>
            </div>
