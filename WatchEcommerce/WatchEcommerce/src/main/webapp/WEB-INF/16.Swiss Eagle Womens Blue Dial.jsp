...
<title>Swiss Eagle Womens Blue Dial</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Swiss Eagle Womens Blue Dial </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/16.Swiss_eagle.jpg" style="height :400px;width: 200px"/>
            </div>
