...
<title>Samsung Galaxy Watch4</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Samsung Galaxy Watch4</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/31.Samsung_sportswear.webp" style="height :400px;width: 400px"/>
            </div>
