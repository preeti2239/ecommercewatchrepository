...
<title>Titan Digital Dail</title>
</head>
<style>
body {
...
<body>
    ...
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u> Titan Digital Dail </u></h2></div>
          
        <div class="leftpane">
            <img src="./image/7.Titan Digital Clear Dial Boy's Watch.jpg" style="height :400px;width: 400px"/>
            </div>
