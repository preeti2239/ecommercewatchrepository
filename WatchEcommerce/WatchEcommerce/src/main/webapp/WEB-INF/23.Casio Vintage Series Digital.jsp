...
<title>Casio Vintage Series Digital</title>
<style>
body {
...
<body>
    <div class="container">
        <div class="toppane">
            ...
            <h2 style="text-align: center;color:red"> <u>Casio Vintage Series Digital</u></h2></div>
          
        <div class="leftpane">
            <img src="./image/23.Casio_Vintage.jpg" style="height :400px;width: 300px"/>
            </div>
